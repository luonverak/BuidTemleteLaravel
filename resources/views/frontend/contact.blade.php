                    ...
                    <div class="col-4">
                        <div class="wrap-follow">
                            ...
                            <ul>
                                ...
                                <li>
                                    <img src="assets/icon/phone.jpg" width="40px"> <a href="">012 333 444 / 010 232
                                        323</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <form action="" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="tel" class="box" placeholder="Telephone" required minlength="9"
                                            maxlength="10">
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-12">
                                        <div class="wrap-btn">
                                            <button type="submit" name="btn_message"><i
